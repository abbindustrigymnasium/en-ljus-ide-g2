...
componentDidMount() { //Körs när allt är inladdat
    ...
    fetch('iot.abbindustrigymnasium.se:3000/grupp2/Str', {  //Urlen där vi vill skicka ifrån (Detta är datorns ipadress, hämtas via ipconfig i cmd, ip4)
...
InsertDataToServer =() => {
	console.log("äöäöl");
	fetch('iot.abbindustrigymnasium.se:3000/grupp2/',{ //Bestämmer vart det nya värdet hamnar.
